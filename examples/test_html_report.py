...
def main():
    ...
    print("\n[TIP] 报告包含以下内容：")
    print("  1. 核心指标 KPI 卡片（6个关键指标）")
    print("  2. 绩效摘要表格（详细指标列表）")
    print("  3. 净值曲线图（策略 vs 基准）")
    print("  4. 回撤分析图（水下图）")
    print("  5. 收益率分布直方图")
    print("  6. 月度收益热力图")
    print("  7. 换手率分析图")
